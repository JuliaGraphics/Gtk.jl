...

{
    ...
    "title": "Sorting",
    "category": "section",
    "text": "We next want to make the tree view sortablefor (i,c) in enumerate([c1,c2,c3])\n  GAccessor.sort_column_id(c,i-1)\nendIf you now click on one of the column headers, the data will be sorted with respect to the selected column. You can even make the columns reordarablefor (i,c) in enumerate([c1,c2,c3])\n  GAccessor.reordable(c,i-1)\nend"
},
