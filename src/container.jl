...
immutable GtkNullContainer_new <: GtkContainer end
function push!(::GtkNullContainer_new, w::GtkWidget)
...
convert(::Type{Ptr{GObject}},::GtkNullContainer_new) = convert(Ptr{GObject},C_NULL)
